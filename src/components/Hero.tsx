  ...
  return (
    <section className="relative h-screen min-h-[700px] w-full overflow-hidden">
      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center px-6"><div className="max-w-4xl">
        ...
        <h1 className="font-display font-light text-ivory-50 text-display-xl text-balance text-shadow-cinematic opacity-0" style={{ animation: 'fadeUp 1s ease-out 0.5s forwards' }}>See more.<br />Go further.<br /><span className="italic font-normal text-ochre-300">Travel differently.</span></h1>
        <p className="mt-8 text-base md:text-lg text-ivory-200/90 max-w-2xl mx-auto text-balance text-shadow-soft opacity-0" style={{ animation: 'fadeUp 0.8s ease-out 0.9s forwards' }}>Creating memorable group travel experiences across Sydney and the Central Coast.</p>
